...
--
-- insert into drinks (drink_type, name, price, ingredients, menu_id)values('NonAlcoholicDrink', 'Strawberry Mocktail', 12.99, '5 strawberries, sugar, water', 1);
--
-- insert into  drinks (drink_type, name, price, ingredients, menu_id)values ('AlcoholicDrink', 'Martini', 15.00, 'Gin, Dry Vermouth', 2);
--
