...
insert into menus(id, name)values ( 2, 'mocktails');

insert into drinks (id, name, price, ingredients, alcohol, menu_id)values (1, 'aardbei mocktail', 12.99, '5 aardbeien, rietsuiker, 1 glas water', false, 2);
